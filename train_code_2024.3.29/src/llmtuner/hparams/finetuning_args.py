...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments):
    ...
    using_reward_difference: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether or not to use reward difference as a regular term for reward signal."},
    )
    coef_lambda:Optional[float] =field(
        default=0.0,
        metadata={"help": "Regularization coefficient of reward difference, default 0.0 ."},
    )
