...
# from transformers import FalconPreTrainedModel,FalconModel
...
# class FalconRewardModel(FalconPreTrainedModel):
#     def __init__(self, config):
#         super().__init__(config)
...
# class GemmaRewardModel(GemmaPreTrainedModel):
#     def __init__(self, config):
#         super().__init__(config)
...
# class MistralRewardModel(MistralPreTrainedModel):
#     def __init__(self, config):
#         super().__init__(config)
