...
# from model import FalconRewardModel,GemmaRewardModel
# from model import Qwen2RewardModel,BloomRewardModel,MistralRewardModel
...
def train():
    ...
    #     model = FalconRewardModel.from_pretrained(
    #         args.model_name_or_path,
    #         cache_dir=args.cache_dir,
    #     )
    # elif args.model_type == 'gemma':
    #     model = GemmaRewardModel.from_pretrained(
    #         args.model_name_or_path,
    #         cache_dir=args.cache_dir,
    #     )
    # elif args.model_type == 'qwen2':
    #     model = Qwen2RewardModel.from_pretrained(
    #         args.model_name_or_path,
    #         cache_dir=args.cache_dir,
    #     )
    # elif args.model_type == 'bloom':
    #     model = BloomRewardModel.from_pretrained(
    #         args.model_name_or_path,
    #         cache_dir=args.cache_dir,
    #     )
    # elif args.model_type == 'mistral':
    #     model = MistralRewardModel.from_pretrained(
    #         args.model_name_or_path,
    #         cache_dir=args.cache_dir,
    #     )
